...
* v1.0.0 2021-05-24
  ...
  * This architecture will perform well and provide an easier & faster UI development changes thanks to the Salesforce Platform. It will also benefits from __all expended capabilities__ offered by the platform: community, registration form, report & dashboard 
